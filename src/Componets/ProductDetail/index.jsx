...
const ProductDetail = () => {
    ...
    return (
        <aside
            className={`${context.isProductDetailOpen ? 'flex' : 'hidden'} product-detail flex-col fixed right-0 border-4 border-customYellow  bg-black/90 rounded-lg text-white`}>
            ...
            <div className='productDetail-info p-5'>
                <h3 className='text-2xl font-dancing'>{context.productToShow.title}</h3>
